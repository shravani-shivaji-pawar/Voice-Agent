...
def _detect_explicit_language_request(text: str) -> str | None:
    ...
    if any(phrase in t for phrase in ["speak hindi", "talk in hindi", "continue in hindi", "hindi mein baat", "hindi me baat", "hindi bol", "hindi me baat karo", "hindi mein baat karo", "हिंदी", "हिन्दी", "हिंदे"]):
        return "hi"
    # Check Marathi requests
    if any(phrase in t for phrase in ["speak marathi", "talk in marathi", "continue in marathi", "marathi mein baat", "marathi me baat", "marathi bol", "मराठी"]):
        return "mr"
    return None
...
def get_language_instruction(language: str) -> str:
    ...
    instructions = {
        ...
        "hi": "Respond in warm, natural Hindi. Use common English words (like property, flat, budget, location, configuration) where it sounds more natural and conversational than formal Hindi.",
        "mr": "Respond in warm, natural Marathi. Use common English words (like property, flat, budget, location, configuration) where it sounds more natural and conversational than formal Marathi.",
        "hinglish": (
